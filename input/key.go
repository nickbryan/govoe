...
// Key represents a single key on the keyboard. This package exports GLFW key codes but you can use your own as
// long as the are of the Key type.
type Key int
...
// ModifierKey represents a single keyboard modifier key. This package exports GLFW modifier codes but
// you can use your own as long as the are of the ModifierKey type.
type ModifierKey int

const (
	ModifierShift   = ModifierKey(glfw.ModShift)
	ModifierControl = ModifierKey(glfw.ModControl)
	ModifierAlt     = ModifierKey(glfw.ModAlt)
	ModifierSuper   = ModifierKey(glfw.ModSuper)
)

// Action indicates what caused the key event to trigger. Either the key was pressed or the key was released.
// The This package GLFW action codes but you can use your own as long as the are of the Action type.
type Action int

const (
	KeyPressed  = Action(glfw.Press)
	KeyReleased = Action(glfw.Release)
)
